...
require (
	...
	github.com/openshift-pipelines/pipelines-as-code v0.37.8 // indirect
...
replace github.com/konflux-ci/e2e-tests => github.com/konflux-ci/e2e-tests v0.0.0-20260505065659-c430de73a6ed
